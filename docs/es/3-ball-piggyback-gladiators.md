...
**Dificultad**: Difícil
**Material**: Tres pelotas de malabares por pareja, arena delimitada
...
- Tarjeta de fuente de UCircus: [3 Ball Piggyback Gladiators](https://ucircus.co.uk/resources-circus-games/)
- Clases de UCircus: Pelotas, Eliminación, Malabares
- Imagen de fuente local: `../img/3-ball-piggyback-gladiators.jpg`
- Manejo de la fuente: No se encontró una fuente de reglas independiente exacta; esto se infiere del título/imagen de UCircus y del formato más amplio de gladiadores.

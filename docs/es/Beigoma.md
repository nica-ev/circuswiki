...
tags:
  ...
  - moc
title: Beigoma
description: Resumen de Beigoma, un juego tradicional japonés de peonzas de batalla que se juega con pequeñas peonzas de metal fundido.
authors:
  - Marc Bielert
...
translation_metadata_updated: 2026-06-14T15:38:41+00:00
source:
  - Tokyo Beigoma
...
---
> [!info] Resumen
> Beigoma es un juego tradicional japonés de trompos de batalla que se juega con pequeños trompos de metal fundido, una cuerda para enrollarlos y una superficie de juego cubierta de tela llamada "suelo".
...
1. Prepara una cuerda con nudos que puedan sujetar la punta del Beigoma.
...
## **Estilos de juego principales**:

- **Riki**: gana el trompo que gira más tiempo.
- **Hajiki**: gana un trompo al sacar otro trompo del suelo de juego.
- **Juego con trompos normales**: se utilizan trompos sin modificar para mantener alto el factor suerte y hacer que los grupos de habilidades mixtas estén más equilibrados.
- **Juego con trompos modificados**: los trompos se ajustan para un giro más largo, ataques más fuertes o reglas específicas de torneo.

## **Páginas de este clúster**:

### Primeros pasos

- [Cómo jugar a Beigoma](Wie%20spielt%20man%20Beigoma.md)
- [Terminología de Beigoma](Beigoma%20Terminologie.md)
- [Equipo y configuración de Beigoma](Beigoma%20Equipment%20and%20Setup.md)
- [Crear un suelo de Beigoma](Making%20a%20Beigoma%20Floor.md)
- [Reglas básicas de Beigoma y arbitraje](Basic%20Beigoma%20Rules%20and%20Refereeing.md)
...
Basado principalmente en material de [Tokyo Beigoma](https://tokyo-beigoma.com/)

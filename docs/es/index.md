...
tags:
  - moc
  - dynamic
title: Inicio de CircusWiki
description: Introducción a CircusWiki, una colección de conocimiento abierta y curada sobre pedagogía circense, juegos de movimiento, práctica inclusiva y temas relacionados.
authors:
  - Marc Bielert
...
-   __Malabares__
    ...
    Fundamentos, ejercicios, materiales e ideas de juego sobre malabares y manipulación de objetos.

    [Abrir Malabares](Jonglage.md){ .md-button }

-   __Beigoma__

    ---

    Una colección en crecimiento sobre Beigoma: material, montaje, reglas del juego, formatos e ideas para talleres.

    [Abrir Beigoma](Beigoma.md){ .md-button }

-   __Talleres y artículos__

    ---

    Materiales prácticos, talleres, tutoriales y artículos de diversas fuentes y proyectos.
...
-   __Archivo Kaskade__
    ...
    Transcripciones y contenidos preparados de la revista Kaskade: unos 30 años de historia del malabarismo y el circo.

    [Abrir Archivo Kaskade](Kaskade%20Workspace.md){ .md-button }

-   __NICA e.V.__

    ---

    Documentación sobre métodos de trabajo, herramientas digitales y estructuras organizativas de NICA e.V.

    [Abrir Documentación NICA](Dokumentation%20Nica%20eV.md){ .md-button }

...
**Dificuldade**: Difícil  
**Material**: Clavas, monociclos ou outros objetos de equilíbrio  
**Duração**: aprox. 5-15 minutos

## Descrição do Jogo

Os jogadores equilibram um objeto acordado, como uma clava ou até mesmo um monociclo, no queixo ou noutro ponto de equilíbrio definido. O último jogador a manter o equilíbrio vence.

## Variações

Adicione movimento ou um pequeno percurso de obstáculos se o equilíbrio básico for muito fácil.

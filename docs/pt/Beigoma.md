...
translation_updated: 2026-06-12T21:03:13+00:00
...
translation_metadata_updated: 2026-06-12T21:03:13+00:00
source:
  - Tokyo Beigoma
...
Beigoma é um antigo jogo japonês de piões. Os piões são pequenos, pesados e geralmente feitos de metal fundido. Os jogadores enrolam uma fina corda à volta do pião, lançam-no numa superfície de jogo de pano esticado e competem para manter o seu próprio pião a girar mais tempo ou para derrubar outros piões da área de jogo.
...
- Limas ou ferramentas opcionais para modificação avançada de piões

Consulte [Equipamento e Montagem de Beigoma](Beigoma%20Equipment%20and%20Setup.md) e [Fazer um Chão de Beigoma](Making%20a%20Beigoma%20Floor.md) para notas mais práticas sobre a montagem.
...
- **Riki**: ganha o pião que girar mais tempo.
- **Hajiki**: um pião ganha ao derrubar outro pião do chão de jogo.
- **Jogo com piões normais**: usam-se piões não modificados para manter o fator sorte elevado e tornar os grupos com diferentes níveis de habilidade mais equilibrados.
...
- [Fazer um Chão de Beigoma](Making%20a%20Beigoma%20Floor.md)
- [Regras Básicas de Beigoma e Arbitragem](Basic%20Beigoma%20Rules%20and%20Refereeing.md)

### Formatos de Jogo

- [Jogo de Cartas de Velocidade de Beigoma](Beigoma-Spiel-Speed.md)
...
- [Jogo de Pontos de Beigoma](Beigoma%20Point%20Match.md)
- [Jogo de Torneio de Beigoma](Beigoma%20Tournament%20Match.md)
- [Jogo de Modificação de 10 Minutos de Beigoma](Beigoma%2010-Minute%20Modification%20Game.md)
...
Use Beigoma comuns e não modificados quando iniciantes e jogadores experientes jogam juntos. Isto mantém o resultado menos previsível e dá aos novos jogadores uma chance realista de participar.

Para workshops, ensine a enrolar e a lançar antes de explicar as regras detalhadas. Formatos estruturados como Speed ou Block Game funcionam melhor assim que a maioria dos participantes consegue fazer um pião girar pelo menos às vezes.

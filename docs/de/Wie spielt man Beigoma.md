...
title: Wie man Beigoma spielt
description: Anfängerleitfaden zur Vorbereitung, zum Aufwickeln, Werfen und Spielen der ersten Runden Beigoma.
authors:
  - Marc Bielert
source:
  - Tokyo Beigoma
...
1. Platziere die Spitze des Beigoma zwischen den beiden Knoten.
2. Halte das lose Ende mit dem Daumen gegen den Kreisel.
3. Wickle die Schnur fest um den Kreisel und halte dabei die Spitze mittig zwischen den Knoten.
4. Halte das Aufwickeln fest und gleichmäßig. Ein lockeres Aufwickeln führt meist zu einem schwachen oder instabilen Wurf.
...
1. Zwei Spieler werfen ihre Beigoma gleichzeitig auf die Spielfläche.
2. Wenn beide Kreisel landen und sich drehen, gewinnt der Kreisel, der sich am längsten dreht.
3. Wenn ein Spieler die Spielfläche verfehlt, verliert dieser Spieler oder die Runde wird wiederholt, je nach lokaler Regel.
4. Wenn beide Kreisel gleichzeitig die Spielfläche verlassen, wird die Runde wiederholt.

...
title: Fire Water Sand
description: A command game where the group quickly reacts to announced terms and finds suitable movements or positions.
authors:
  - Marc Bielert
category:
  - warm-up
  - bewegung
Schwierigkeit: easy
Material: Elevated surfaces, optional drum
Spieldauer: 5-15
...
translation_metadata_updated: 2026-06-14T15:49:19+00:00
...
All players move freely around the room. If a drum is available, the facilitator can set a rhythm for the players to move to – sometimes faster, sometimes slower. The facilitator can then call out various commands that the players must execute.
...
**Ice**: Everyone freezes in place.

**Sun**: All players lie on their backs on the floor, as if they are sunbathing.

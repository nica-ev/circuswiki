...
title: "Quidditch Juggle"
description: "A large team game that turns Quidditch-style roles into a juggling and target-throwing convention game."
authors:
...
1. Mark a rectangular field with one target hoop or scoring zone at each end.
2. Split the group into two teams and assign roles.
3. Chasers score by getting the main ball through the opposing target.
4. Players carrying or controlling the main ball must keep the agreed juggling task active.
5. Beaters may tag or hit opponents only with soft balls and only below shoulder height.
6. A tagged player pauses briefly, returns to a reset point, or completes a small penalty task before rejoining.
7. The seeker task runs alongside the main game and should be visible enough that both teams understand when it is completed.
...
[JugglingWorld - Juggling Games](https://www.jugglingworld.biz/tricks/juggling-games/), section: Miscellaneous!.

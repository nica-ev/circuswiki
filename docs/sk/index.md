...
translation_metadata_updated: 2026-06-14T15:53:56+00:00
...
-   __Pohybové hry__
    ...
    Hry, rozcvičky, formy spolupráce, zoznamovacie hry a pohybové úlohy pre skupiny.

    [Otvoriť pohybové hry](Bewegungs-Spiele.md){ .md-button }

-   __Žonglovanie__

    ---

    Základy, cvičenia, materiály a herné nápady týkajúce sa žonglovania a manipulácie s objektmi.

    [Otvoriť žonglovanie](Jonglage.md){ .md-button }
...
-   __Workshopy a články__
    ...
    Praktické materiály, workshopy, návody a články z rôznych zdrojov a projektov.
...
-   __NICA e.V.__
    ...
    Dokumentácia o pracovných metódach, digitálnych nástrojoch a organizačných štruktúrach NICA e.V.

    [Otvoriť dokumentáciu NICA](Dokumentation%20Nica%20eV.md){ .md-button }
...
CircusWiki je voľne prístupný a bez reklám. Napriek tomu vznikajú náklady: na technickú infraštruktúru, nástroje, preklady, archiváciu a dlhodobú údržbu. Snažíme sa využívať granty, ale okrem toho potrebujeme aj udržateľný model darcovstva a podpory.

Otvorene ukazujeme, na čo sa peniaze používajú, a pravidelne a transparentne o tom informujeme.

[Podporiť projekt](unterstuetzen.md){ .md-button }
